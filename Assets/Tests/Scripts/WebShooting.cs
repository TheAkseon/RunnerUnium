...
public class WebShooting : MonoBehaviour
{
    ...
    [SerializeField] private float _baseFiringRate = 1f; // ����� ���������
    ...
    private void Start()
    {
        ...
        Debug.Log("������ ����� ����� - " + SaveData.Instance.Data.BaseDamage);
        _firingRate = SaveData.Instance.Data.BaseFiringRate;
        Debug.Log("������ �������� �������� ����� - " + _firingRate);
    ...
    {
        Debug.Log("������� firing rate " + _firingRate);
        Debug.Log("������� firing rate " + _baseFiringRate);
